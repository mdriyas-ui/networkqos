...
insert  into `login`(`sno`,`username`,`password`,`email`,`bandwidth`,`phonetype`,`networkname`,`simstate`,`networktype`,`osversion`) values (1,'s','s','s','34','ds','d','ds','ds','ds'),(2,'san','san','san','51','GSM','Android','89014103211118510720','UMTS (3G)','4.2.2');
